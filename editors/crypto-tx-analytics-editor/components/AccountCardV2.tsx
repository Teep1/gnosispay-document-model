...
export function AccountCard({
  ...
  const gradient = currencyGradients[baseCurrency] || "from-gray-600 to-gray-800";
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between">
          <div>
            <p className="text-white/70 text-sm font-medium tracking-wide uppercase">{accountName}</p>
            <p className="text-white/50 text-xs mt-0.5 font-mono">{baseCurrency} • Gnosis Chain</p>
          </div>
        ...
        <div className="mt-8">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-semibold text-white/80">{currencyCode === "GBP" ? "£" : currencyCode === "EUR" ? "€" : "$"}</span>
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/80 font-mono text-sm tracking-wider">{cardLastFour}</span>
          </div>
        </div>
      </div>
    </div>
