...
import type { GnosisPayStablecoin } from "../../../document-models/gnosispay-analytics/src/base-currency-detection.js";
...
export function FinancialAnalytics({
  ...
  const momChange =
    previousMonthSpending > 0
      ? ((thisMonthSpending - previousMonthSpending) / previousMonthSpending) *
        100
      : 0;
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <DashboardCard
          ...
          value={`${currencySymbol}${thisMonthSpending.toLocaleString(
            undefined,
            {
        ...
        <DashboardCard
          ...
          value={`${currencySymbol}${availableToSpend.toLocaleString(
            undefined,
            {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2,
        ...
        <DashboardCard
          ...
          value={`${currencySymbol}${projectedMonthSpend.toLocaleString(
            undefined,
            {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2,
...
export function MonthlyComparison({
  ...
  const percentChange =
    previousMonth > 0 ? (difference / previousMonth) * 100 : 0;
