  ...
  const steps = [
    {
      ...
      description: "Your personal banking dashboard for crypto-powered spending.",
      icon: "👋",
    },
    {
      title: "Connect Your Wallet",
      description: "Link your Gnosis Safe to track your spending and transactions.",
      icon: "🔗",
    },
    {
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-900">Etherscan API Key</p>
                    <p className="text-xs text-blue-700 mt-1">
                      We'll fetch your transaction history from Gnosis Chain. You can get a free API key from Etherscan.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-700">{walletAddress || "0xe1de...afc7"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-700">Transactions will be fetched automatically</p>
                </div>
              </div>
            </div>
          )}
