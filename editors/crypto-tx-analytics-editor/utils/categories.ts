...
export const categoryConfig: Record<SpendingCategory, CategoryConfig> = {
  food: {
    ...
    keywords: ["restaurant", "cafe", "food", "grocery", "supermarket", "delivery", "uber eats", "deliveroo"],
  },
  transport: {
    label: "Transport",
    icon: "🚗",
    color: "text-blue-600",
    bgColor: "bg-blue-100",
    keywords: ["uber", "lyft", "taxi", "bus", "train", "metro", "fuel", "parking", "transport"],
  },
  shopping: {
    label: "Shopping",
    icon: "🛍️",
    color: "text-pink-600",
    bgColor: "bg-pink-100",
    keywords: ["amazon", "shop", "store", "retail", "clothing", "electronics", "market"],
  },
  entertainment: {
    label: "Entertainment",
    icon: "🎬",
    ...
    keywords: ["netflix", "spotify", "cinema", "movie", "game", "entertainment", "subscription"],
  },
  utilities: {
    label: "Utilities",
    icon: "⚡",
    ...
    keywords: ["electricity", "water", "gas", "internet", "phone", "bill", "utility"],
  },
  travel: {
    label: "Travel",
    icon: "✈️",
    color: "text-cyan-600",
    bgColor: "bg-cyan-100",
    keywords: ["hotel", "flight", "booking", "airbnb", "travel", "vacation", "trip"],
  },
  health: {
    label: "Health",
    icon: "🏥",
    color: "text-red-600",
    bgColor: "bg-red-100",
    keywords: ["pharmacy", "doctor", "hospital", "medical", "health", "fitness", "gym"],
  },
  education: {
    label: "Education",
    icon: "📚",
    ...
    keywords: ["course", "school", "university", "book", "education", "learning", "tutorial"],
  },
  income: {
    label: "Income",
    icon: "💰",
