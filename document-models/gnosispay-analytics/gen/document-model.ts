      ...
      modules: [
        {
          ...
          operations: [
            ...
            {
              description:
                "Import multiple structured transactions at once. Preferred over CSV import for programmatic imports from APIs like Etherscan.",
              errors: [
                {
